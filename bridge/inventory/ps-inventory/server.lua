...
gg.inventory.addItem = function(src, data)
    ...
    TriggerClientEvent('ps-inventory:client:ItemBox', src, gg.framework.GetItemData(data.item), 'add', data.count)
    return success
end
...
gg.inventory.removeItem = function(src, data)
    ...
    TriggerClientEvent('ps-inventory:client:ItemBox', src, gg.framework.GetItemData(data.item), 'remove', data.count)
    return success
end
