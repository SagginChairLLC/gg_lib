...
function buildTaxiScript(): SettingsScript {
    return {
        ...
        groups: [
            ...
            { id: 'depot', label: 'Depot', icon: 'fa-warehouse', help: 'Each taxi office, its ped, its blip and where rentals spawn.' },
        ],
        entries: [
            entry({
            ...
            entry({
                path: 'settings.depots.list',
                group: 'depot',
                label: 'Depots',
                help: 'Each row is a taxi office. Open one to move its ped, restyle its blip and place the bays a rented vehicle spawns into.',
                live: false,
                type: 'list',
                item: [
                    { key: 'label', label: 'Name', type: 'string' },
                    { key: 'coords', label: 'Ped Position', type: 'coords', help: 'Where the depot ped stands. Place it in game rather than typing coordinates.' },
                    { key: 'ped_model', label: 'Ped Model', type: 'ped' },
                    { key: 'show_blip', label: 'Show Blip', type: 'boolean' },
                    { key: 'blip_sprite', label: 'Blip Icon', type: 'blipsprite' },
                    { key: 'blip_color', label: 'Blip Color', type: 'blipcolor' },
                    { key: 'return_zone', label: 'Return Area', type: 'list', item_type: 'coords', edit_mode: 'polygon' },
                    { key: 'spawns', label: 'Rental Bays', type: 'list', item_type: 'coords', preview_model: 'taxi', min_gap: 0.5 },
                ],
                item_default: {
                    label: 'New Depot',
                ...
                default: [
                    {
                        label: 'Mirror Park',
                        coords: { x: 895.2, y: -179.3, z: 74.7, heading: 148.0 },
                        ped_model: 'g_m_m_armboss_01',
                        show_blip: true,
                        blip_sprite: 56,
                        blip_color: 5,
                        return_zone: [],
                        spawns: [
                            { x: 903.1, y: -173.5, z: 73.9, heading: 240.0 },
                            { x: 906.4, y: -176.8, z: 73.9, heading: 240.0 },
                        ],
                    },
                    {
                        label: 'Vespucci Beach',
                        coords: { x: -1038.6, y: -1396.1, z: 5.5, heading: 32.0 },
                        ped_model: 'a_m_y_beach_01',
                        show_blip: true,
                        blip_sprite: 56,
                        blip_color: 5,
                        return_zone: [
                            { x: -1044.2, y: -1401.5, z: 5.5 },
                            { x: -1030.7, y: -1392.2, z: 5.5 },
                            { x: -1024.9, y: -1402.8, z: 5.5 },
                            { x: -1038.4, y: -1412.1, z: 5.5 },
                        ],
                        spawns: [
                            { x: -1032.8, y: -1404.9, z: 4.9, heading: 122.0 },
                        ],
                    },
                ],
            }),
